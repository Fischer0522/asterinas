...
#define BASE_DIR "/ext2/symlink_test"
...
FN_TEST(symlink_long_roundtrip)
{
	...
	// Full path: /ext2/symlink_test/a/b/c/d/e/f/g/target (> 60 chars)
	const char *dirs[] = {
		BASE_DIR "/a",
		BASE_DIR "/a/b",
		BASE_DIR "/a/b/c",
		BASE_DIR "/a/b/c/d",
		BASE_DIR "/a/b/c/d/e",
		BASE_DIR "/a/b/c/d/e/f",
		BASE_DIR "/a/b/c/d/e/f/g",
	};
	const char *target = BASE_DIR "/a/b/c/d/e/f/g/target";
